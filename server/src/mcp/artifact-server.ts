...
const VALID_TYPES: ArtifactType[] = ['chart', 'report', 'data', 'code', 'pikchr', 'html']
  ...
  tools: [
    ...
    },
    {
      ...
      description:
        ...
        'Types: "chart" (Vega-Lite JSON), "report" (Markdown), "data" (JSON/CSV), "code" (any language), "pikchr" (diagram), "html" (self-contained HTML page rendered in a sandboxed iframe). ' +
      ...
      inputSchema: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            enum: VALID_TYPES,
            description: 'Artifact type: chart | report | data | code | pikchr | html',
          },
          content: {
            type: 'string',
